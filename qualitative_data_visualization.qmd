  ...
  <div class="card-body">
    <div class="d-flex gap-3 align-items-start">
      ...
      <div>
        ...
        <p>Evergreen encourages readers to look beyond basic charts. Alternatives include:</p>

        <ul>
          <li>Images with call-out annotations</li>
          <li>Journey maps</li>
        ...
        <p>
          These techniques help communicate qualitative insights clearly and meaningfully.
        </p>
      </div>
