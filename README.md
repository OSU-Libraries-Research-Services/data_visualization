...
The __[Financial Times Visual Vocabulary](https://ft-interactive.github.io/visual-vocabulary/)__ offers a **visual taxonomy**—or categorized collection of chart types—based on the kind of relationship or message you want to show (e.g., change over time, distribution, correlation. It helps answer the question: ***“What’s the best way to visualize this data?”***
