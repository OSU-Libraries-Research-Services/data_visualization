...
2. Go to [https://go.osu.edu/python_mastering_basics_ai_files](https://go.osu.edu/python_mastering_basics_ai_files)
3. Download and place in your **python_workshop** folder:

      - carmen_ohio.txt
      - carmen_ohio_revised.txt
      - python_mastering_basics_workshop_exercises.py
4. Go to [https://go.osu.edu/python_mastering_basics_ai_slides](https://go.osu.edu/python_mastering_basics_ai_slides) and place slides on second screen.
