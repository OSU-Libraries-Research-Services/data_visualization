...
## ScopusSearch
__[ScopusSearch](https://pybliometrics.readthedocs.io/en/stable/reference/scopus/ScopusSearch.html)__ is one of the 11 APIs available to interact with Elsevier's Scopus database. The ScopusSearch class in pybliometrics allows you to ...

- Query Scopus using all fields available in Scopus advanced search except “INDEXTERMS()” and “LIMIT-TO()”.
- Filter results
- Retrieve metadata

The query returns a list of named tuples that can be converted into a DataFrame with pandas.
