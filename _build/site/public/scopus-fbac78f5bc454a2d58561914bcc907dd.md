...
### (label)=Step 2. Retrieve and store results
...
The AuthorSearch class in **pybliometrics** interfaces with the Scopus AuthorSearch API and allows you to retrieve information for authors indexed in Scopus. To practice reading, interpreting, and applying concepts introduced in the **pybliometrics** documentation we will 

1. Create a list of unique author_ids gathered from our results stored in [](Step 2. Retrieve and store results)
