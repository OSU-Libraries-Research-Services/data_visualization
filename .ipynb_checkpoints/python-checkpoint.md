...
+++
Get up and running in a weekend with Eric Matthes' __[Python crash course : a hands-on, project-based introduction to programming, 3rd edition](https://search.library.osu.edu/permalink/01OHIOLINK_OSU/1n38col/cdi_globaltitleindex_catalog_345576859)__. Using approachable language paired with coding examples, this book introduces Python variables, data types, methods, functions, and more while pushing you to try each introduced concept yourself. 
:::
...
+++
Learn Python basics and then master using Python to scrape websites, match text patterns using regular expressions, read documents, work with .csv and .json data, schedule tasks, manipulate images, and more with Al Sweigart's __[Automate the boring stuff with Python : practical programming for total beginners, 3rd edition](https://search.library.osu.edu/permalink/01OHIOLINK_OSU/1n38col/cdi_safari_books_v2_9798341620094)__  Each chapter includes practice questions, helping you to apply what you've learned and become a more confident programmer.
:::
...
+++
__[Python tools for scientists : an introduction to using Anaconda, Jupyterlab, and Python's scientific libraries](https://search.library.osu.edu/permalink/01OHIOLINK_OSU/1oqfg3i/alma991085500459808507)__  
by Lee Vaughan  
...
A library based on matplotlib and used to format and create more attractive visualizations.  -->

## Tutorials
University Libraries offers a variety of data skills [workshops and events](https://library.osu.edu/events?tid=921) for Ohio State faculty, students and staff throughout the academic year. Additional hand-on tutorials cam be fouind in the menu located at the bottom left of this webpage.