...
+++
Jonathan Schwabish shows Excel remains a powerful tool for visualizing data in __[Data Visualization in Excel: A Guide for Scholars, Researchers, and Wonks](https://search.library.osu.edu/permalink/01OHIOLINK_OSU/1hnts55/cdi_askewsholts_vlebooks_9781000877373)__ . Each chapter provides detailed instructions for creating nearly 30 additional graphs beyond Excel’s default graph library. From the basic heatmaps to advanced Marimekko charts, this book will guide you in crafting more colorful, effective data visualizations for your audience.  
:::
...
+++
Cole Nussbaumer Knaflic's __[Storytelling with Data: A Data Visualization Guide for Business Professionals](https://search.library.osu.edu/permalink/01OHIOLINK_OSU/1hnts55/cdi_proquest_ebookcentral_EBC4187267)__ is designed to help you master communicating with data. Paired with its companion book __[Storytelling with data : let's Pratice!](https://search.library.osu.edu/permalink/01OHIOLINK_OSU/1hnts55/cdi_proquest_ebookcentral_EBC5940216)__, Knaflic pushes you to make your graphs clear, concise, and actionable, all while focusing on the needs of your audience.
:::
::::
